...
public class RetrofitFactory9001 {
    ...
    public static Retrofit getRetrofit() {
        if (retrofit == null) {
            synchronized (RetrofitFactory9001.class) {
                if (retrofit == null) {
                    // 指定缓存路径,缓存大小 50Mb
                    ...
                    ClearableCookieJar cookieJar =
                            new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(XQWApplication.appContext));
