...
public class NewsArticleView extends BaseListFragment<NewsContrat.Presenter> implements NewsContrat.View{
    ...
    @Override
    public void setPresenter(NewsContrat.Presenter presenter) {
